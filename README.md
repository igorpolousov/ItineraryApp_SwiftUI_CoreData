#  SwiftUI + CoreData
  ...
  - Из-за особенностей struct добавлено некоторое количество модификаторов("properties wrappers) которые дополняют совйства типов данных и которые нужно знать дополнительно.
